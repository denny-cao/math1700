...
\begin{document}
    ...
    \begin{enumerate}[(1)]
        ...
        \begin{proof}
            ...
            Where $P(x,y)$ is the statement that $x > y$ and $Q(x,y)$ is the statement that $x$ has a prime factor greater than $y$. We construct a counterexample by choosing $x = 8$ and $y = 2$. We can verify that $P(8,2)$ is true, but $Q(8,2)$ is false. 
        \end{proof}
        --- \name
    \end{enumerate}
